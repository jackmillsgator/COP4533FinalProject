...
vector<int> findMaxProfit(vector<vector<int>> predictedPrices, int c)
{
    ...
    //  **************************************************************************************************  //
    //                                                                                                      //
    //  This algorithm will be almost exactly the same as the algorithm created in Task 6. However, with    //
    //  a time complexity of O(m · n), we are going to replace the nested for loop with recursive calls     //
    //  within each row for each possible pair of a future and previous stock price that could yield a      //
    //  profit.                                                                                             //
    //                                                                                                      //
    //  **************************************************************************************************  //
